import type { TerritoryDefinition, ContinentDefinition, MapData } from '../engine/types';

// Classic Risk: 42 territories, 6 continents
// SVG viewBox: 0 0 1024 792
// Geographic paths from raddrick/risk-map-svg
...
const continents: ContinentDefinition[] = [
  {
    ...
    territoryIds: [
      'na_alaska', 'na_northwest', 'na_greenland', 'na_alberta',
      'na_ontario', 'na_quebec', 'na_western_us', 'na_eastern_us', 'na_central_america',
    ],
    color: '#f9e79f',
  },
  {
    id: 'south_america', name: 'South America', bonus: 2,
    territoryIds: ['sa_venezuela', 'sa_peru', 'sa_brazil', 'sa_argentina'],
    color: '#a9dfbf',
  },
  {
    id: 'europe', name: 'Europe', bonus: 5,
    territoryIds: [
      'eu_iceland', 'eu_britain', 'eu_scandinavia', 'eu_northern_europe',
      'eu_western_europe', 'eu_southern_europe', 'eu_ukraine',
    ],
    color: '#aed6f1',
  },
  {
    ...
    territoryIds: [
      'af_north_africa', 'af_egypt', 'af_congo',
      'af_east_africa', 'af_south_africa', 'af_madagascar',
    ],
    color: '#f5cba7',
  },
  {
    ...
    territoryIds: [
      'as_ural', 'as_siberia', 'as_yakutsk', 'as_kamchatka',
      'as_irkutsk', 'as_mongolia', 'as_japan', 'as_afghanistan',
      'as_china', 'as_middle_east', 'as_india', 'as_siam',
    ],
    color: '#d7bde2',
  },
  {
    id: 'australia', name: 'Australia', bonus: 2,
    territoryIds: ['au_indonesia', 'au_new_guinea', 'au_western_australia', 'au_eastern_australia'],
    color: '#f5b7b1',
  },
];

// Build adjacency map from territory definitions
const adjacency: Record<string, string[]> = {};
for (const t of territories) {
  adjacency[t.id] = t.adjacentTo;
}

export const MAP_DATA: MapData = { territories, continents, adjacency };
